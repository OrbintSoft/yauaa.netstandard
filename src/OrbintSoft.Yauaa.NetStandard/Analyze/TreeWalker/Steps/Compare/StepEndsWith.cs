...
namespace OrbintSoft.Yauaa.Analyze.TreeWalker.Steps.Compare
{
    ...
    /// <summary>
    /// This class defines the EndsWith Step, it is used in parsing to check if the actual value contains at the end of the string the desidered value.
    /// </summary>
    [Serializable]
    public class StepEndsWith : Step
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StepEndsWith"/> class.
        /// This is used only for binary deserialization.
        /// </summary>
        /// <param name="info">The info <see cref="SerializationInfo"/>.</param>
        /// <param name="context">The context <see cref="StreamingContext"/>.</param>
        public StepEndsWith(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        ...
        /// Initializes a new instance of the <see cref="StepEndsWith"/> class.
        /// </summary>
        /// <param name="desiredValue">The desired value you want check if is contained at the end of string of the actual value.</param>
        ...
        /// <summary>
        /// It checks if the actual value contains the desired value at the end of the string, in that case:
        ...
        public override WalkList.WalkResult Walk(IParseTree tree, string value)
        {
            ...
            if (actualValue.ToLower().EndsWith(this.desiredValue))
            {
