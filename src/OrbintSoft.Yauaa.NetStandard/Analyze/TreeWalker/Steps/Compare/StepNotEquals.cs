...
namespace OrbintSoft.Yauaa.Analyze.TreeWalker.Steps.Compare
{
    ...
    /// <summary>
    /// This class defines the NotEquals Step, it is used in parsing to check if the actual value is not equal to the desidered value.
    /// </summary>
    [Serializable]
    public class StepNotEquals : Step
    {
        ...
        /// Initializes a new instance of the <see cref="StepNotEquals"/> class.
        /// </summary>
        /// <param name="desiredValue">The desired value you want check if is not equal to the actual value.</param>
        ...
        /// <summary>
        /// It checks if tha actual value is not equals to the desired value, in that case:
